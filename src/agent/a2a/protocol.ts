...
export const PREDEFINED_ROLES: AgentRole[] = [
  {
    id: 'planner',
    name: 'Planner',
    systemPrompt: 'You are a planning agent. Break complex tasks into subtasks and delegate them to specialized agents using the delegate_task tool. Coordinate results and synthesize final answers.',
  ...
  },
  {
    id: 'builder',
    name: 'Builder',
    systemPrompt: 'You are a builder agent specialized in code generation and implementation. Execute tasks delegated to you and report results back.',
  ...
  },
  {
    id: 'reviewer',
    name: 'Reviewer',
    systemPrompt: 'You are a review agent. Analyze code, results, and outputs for correctness, quality, and completeness. Provide constructive feedback.',
    tools: ['web_browse'],
    maxConcurrent: 2,
  },
  {
    id: 'researcher',
    name: 'Researcher',
    systemPrompt: 'You are a research agent. Gather information from the web, APIs, and other sources. Summarize findings concisely.',
